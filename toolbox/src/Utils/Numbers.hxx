...
namespace Utils {
  ...
  */
  ...
  //!
  //! \tparam T The type of the NaN constant. Supported types include float and double.
  //! \return A NaN constant of type T.
  template <typename T> T NaN();

  //! Returns an infinity constant for the specified type.
  //!
  //! \tparam T The type of the infinity constant. Supported types include float and double.
  //! \return An infinity constant of type T.
  template <typename T> T Inf();

  //! Returns the machine epsilon for the specified type.
  //!
  //! \tparam T The type of the machine epsilon. Supported types include float and double.
  ...
  //!
  //! \tparam T The type for which to compute the square root of machine epsilon. Supported types include float and double.
  ...
  //!
  //! \tparam T The type for which to compute the maximum value. Supported types include float and double.
  ...
  //!
  //! \tparam T The type for which to compute the minimum value. Supported types include float and double.
  //! \return The minimum representable value of type T.
  template <typename T> T minimum_value();

  #ifndef DOXYGEN_SHOULD_SKIP_THIS
  template <> inline float NaN() { return numeric_limits<float>::quiet_NaN(); }
  template <> inline double NaN() { return numeric_limits<double>::quiet_NaN(); }

  template <> inline float Inf() { return numeric_limits<float>::infinity(); }
  template <> inline double Inf() { return numeric_limits<double>::infinity(); }

  template <> inline float machine_eps() { return numeric_limits<float>::epsilon(); }
  template <> inline double machine_eps() { return numeric_limits<double>::epsilon(); }

  template <> inline float sqrt_machine_eps() { return sqrt(numeric_limits<float>::epsilon()); }
  template <> inline double sqrt_machine_eps() { return sqrt(numeric_limits<double>::epsilon()); }

  template <> inline float maximum_value() { return sqrt(numeric_limits<float>::max()); }
  template <> inline double maximum_value() { return sqrt(numeric_limits<double>::max()); }

  template <> inline float minimum_value() { return sqrt(numeric_limits<float>::min()); }
  template <> inline double minimum_value() { return sqrt(numeric_limits<double>::min()); }
  #endif
  ...
  //! Returns the square root of machine epsilon using camel case style for the specified type.
  //!
  //! \tparam T The type for which to compute the square root of machine epsilon. Supported types include float and double.
  //! \return The square root of the machine epsilon of type T.
  //! \deprecated
  ...
  //! Returns the maximum representable value using camel case style for the specified type.
  //!
  //! \tparam T The type for which to compute the maximum value. Supported types include float and double.
  //! \return The maximum representable value of type T.
  //! \deprecated
  ...
  //! Returns the minimum representable value using camel case style for the specified type.
  //!
  //! \tparam T The type for which to compute the minimum value. Supported types include float and double.
  //! \return The minimum representable value of type T.
  //! \deprecated
  ...
  //! Checks if a double value is a regular (finite) number using camel case style.
  //!
  //! \param x The double value to check.
  ...
  //! Checks if a float value is a regular (finite) number using camel case style.
  //!
  //! \param x The float value to check.
  //! \return True if x is a regular number, otherwise false.
  //! \deprecated
  ...
  //! Checks if a double value is unsigned (non-negative integer) using camel case style.
  //!
  //! \param x The double value to check.
  //! \return True if x is unsigned, otherwise false.
  //! \deprecated
  ...
  //! Checks if a float value is unsigned (non-negative integer) using camel case style.
  //!
  //! \param x The float value to check.
  //! \return True if x is unsigned, otherwise false.
  //! \deprecated
  ...
  //! Checks if a NaN value is found in an array of doubles using camel case style.
  //!
  //! \param pv Pointer to the array of double values.
  //! \param DIM The dimension (size) of the array.
  //! \return True if a NaN value is found, otherwise false.
  //! \deprecated
  static inline bool foundNaN(double const* pv, int DIM) { return found_NaN(pv, DIM); }

  //! Checks if a NaN value is found in an array of floats using camel case style.
  //!
  //! \param pv Pointer to the array of float values.
  //! \param DIM The dimension (size) of the array.
  //! \return True if a NaN value is found, otherwise false.
  //! \deprecated
  static inline bool foundNaN(float const* pv, int DIM) { return found_NaN(pv, DIM); }

  //! Checks for NaN values in an array of doubles and logs an error if found using camel case style.
  //!
  //! \param pv Pointer to the array of double values.
  //! \param v_name The name of the variable for logging.
  //! \param DIM The dimension (size) of the array.
  ...
  //! Checks for NaN values in an array of floats and logs an error if found using camel case style.
  //!
  //! \param pv Pointer to the array of float values.
  //! \param v_name The name of the variable for logging.
  //! \param DIM The dimension (size) of the array.
