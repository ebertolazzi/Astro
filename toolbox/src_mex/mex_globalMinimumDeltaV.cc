...
"\n" \
"USAGE:\n" \
"    [t_begin,t_end,P1,V1,W1,P2,V2,W2,DV1,DV2] = globalMinimumDeltaV(mu,t0,P0,V0,P1,V1,t_begin,t_end,t_tolerance,maxDV,NTABLE);\n" \
"\n"
...
namespace AstroLib {
  ...
  #define CMD "[t_begin,t_end,P1,V1,W1,P2,V2,W2,DV1,DV2] = globalMinimumDeltaV(mu,t0,P0,V0,P1,V1,t_begin,t_end,t_tolerance,maxDV,TABLE_SIZE): "
